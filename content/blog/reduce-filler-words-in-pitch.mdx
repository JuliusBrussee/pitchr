...
<FAQSection>
  <FAQItem question="How many filler words per minute is too many in an investor pitch?">
  ...
  <FAQItem question="What is the ideal speaking pace for an investor pitch?">
  ...
  <FAQItem question="How do I stop saying 'um' when pitching investors?">
  ...
  <FAQItem question="Are hedge words worse than 'um' in a pitch?">
