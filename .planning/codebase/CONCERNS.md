...
- Risk: Code assumes env vars exist but doesn't validate. `ELEVENLABS_API_KEY`, `OPENROUTER_API_KEY`, `NEXT_PUBLIC_WS_URL` checked nowhere at startup. If missing, app crashes or behaves unpredictably.
